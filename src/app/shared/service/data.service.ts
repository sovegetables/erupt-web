...
export class DataService {
    ...
    //分页数据对象
    queryEruptTableData(eruptName: string, url: string, page: Page, header?: object, body?: any): Observable<Page> {
        return this._http.post(url, {...page, ...body}, null, {
            observe: "body",
            headers: {
                erupt: eruptName,
                ...header,
    ...
    //获取初始化数据
    getInitValue(eruptName: string, eruptParentName?: string, params: any = null): Observable<any> {
        return this._http.get<any>(RestPath.data + "/init-value/" + eruptName, params, {
            observe: "body",
            headers: {
                erupt: eruptName,
                eruptParent: eruptParentName || '',
